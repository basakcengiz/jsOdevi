...
let sonHarfiA = [];
let id10 = "";
let discontinuedSayisi = 0;
let enPahali = "";
let enUcuz = "";
let price1 = 0;
let price2 = 100;
products.forEach((element) => {
  element.unitPrice >= 30 && element.unitPrice <= 100 && urunSayisi++;
  element.name.startsWith("A") && basHarfiA.push(element);
  element.name.endsWith("a") && sonHarfiA.push(element);
  element.id === 10 && (id10 = element.name);
  element.discontinued === false && discontinuedSayisi++;
  if (element.unitPrice > price1) {
    price1 = element.unitPrice;
    enPahali = element.name;
  }
  if (element.unitPrice < price2) {
    price2 = element.unitPrice;
    enUcuz = element.name;
  }
});
console.log("Fiyatı 30TL'den büyük 100TL'den küçük ürün sayısı:", urunSayisi);

console.log("İsmi A ile başlayan ürünler:");
basHarfiA.forEach((element, index) => {
  console.log(index + 1, element.name);
});

console.log("Son harfi a olan ürünler:");
sonHarfiA.forEach((element, index) => {
  console.log(index + 1, element.name);
});

console.log("ID'si 10 olan ürün:", id10);

console.log("Discontinued'u false olan ürün sayısı:", discontinuedSayisi);

console.log("En pahalı ürünün adı:", enPahali);

console.log("En ucuz ürünün adı:", enUcuz);
